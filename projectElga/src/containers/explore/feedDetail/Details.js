...
function Details(props) {
        ...
        <View style={CommonStyle.bottomSubView}>
          <View style={CommonStyle.bottomotherSubView}>
            <TextInput
              ...
              style={CommonStyle.commentInput}
              multiline={true}
            />
          </View>
          <TouchableOpacity
            ...
            style={CommonStyle.sendCommentBtn}
          >
  ...
  return (
    <View style={[Styles.wrapper, shadow]}>
      <View>
        <View style={Styles.picDetailWrapperHead}>
        ...
        <View style={Styles.actionNav}>
          ...
          <View style={Styles.actionNavBox}>
            ...
            <Text style={Styles.actionNavText}>{`${nFormatter(
              feedData?.noOfComments
            )} ${feedData?.noOfComments > 1 ? "Comments" : "Comment"}`}</Text>
          </View>
        </View>
      </View>
      <KeyboardAvoidingView
